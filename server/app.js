...
app.post('/teams/:team/sub/:username', async (req, res) => {
    try {
        const client = await pool.connect();
        const result = await client.query(`INSERT INTO subscriptions (username, team) VALUES ('${req.params.username}', '${req.params.team}')`)
